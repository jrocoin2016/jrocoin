...
const QString BITCOIN_IPC_PREFIX("Jrocoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Jrocoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Jrocoin: click-to-pay handler");
    else
...
{
    // clicking on Jrocoin: URLs creates FileOpen events on the Mac:
