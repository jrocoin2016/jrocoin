...
// Copyright (c) 2013 The Jrocoin developers
...
uint256 hashGenesisBlock("0x00000fb70b308d7268521ecdaaa177d68c901d8714fc1153e052c2c2be00bef5");
static const unsigned int timeGenesisBlock = 1464746003;
...
const string strMessageMagic = "Jrocoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb06019266192080d9d81af771e13e4220c33102f35d7a170aded1c9180a47d83");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Jrocoin create 06.1";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xc6cfd1b0734300c1b1eba1daf4c6f590613ca2cd8cc8e2079ab93510a6495224"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("JrocoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("JrocoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("JrocoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Jrocoin-miner");
    ...
    try { loop {
        ...
        printf("Running JrocoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("JrocoinMiner terminated\n");
        throw;
    }
}
